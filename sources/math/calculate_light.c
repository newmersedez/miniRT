...
/*   Updated: 2022/03/28 02:58:18 by dmitry           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minirt.h"

// static int	pixel_in_shadow(t_minirt *minirt, const t_point *origin, const t_vec *ray)
// {
// 	t_list	*objects_list;
...
t_color	calculate_light(t_minirt *minirt, t_object *object, t_point *intersection_point)
{
	...
	if (light_angle >= 0 && light_angle <= 1)
	{
		...
		// if (pixel_in_shadow(minirt, intersection_point, &light_ray))
		// {
		// 	color = object->color;
		// 	color.r = 0;
		// 	color.g = 0;
